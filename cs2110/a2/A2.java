 ...
 *
 * 1. Jason Chung and Raphael Thesmar:
 * 2. jkc97 & rft38
 * 3. Took CS1110 (yes):
 * 3. Took CS1110 (no):
 * 4: Took CS1112 (no):
 ...
 *  We thought the assignment was extremely effective in teaching us the syntax <br>
 *  of Java through walkthrough and references to the JavaHyperText. We both learned <br>
 *  a lot and are very well prepared moving forward with while and for loops, conditionals, <br>
 *  and even return statements having learned them in the past. We enjoyed how <br>
 *  we could refresh our memories through the pdfs and JHT entries, and overall <br>
 *  enjoyed the assignment greatly. 
 */
