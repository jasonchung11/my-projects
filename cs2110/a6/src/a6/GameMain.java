 ...
 * This assignment was helpful in getting practice with GUIs. We liked how
 * our final product was a game on our computer, resembling an online game
 * that you can save your progress on. Some of the specifics, such as
 * syntax, was hard to become accustomed to, but the online tutorials were
 * helpful.
 */
    ...
    private static void saveScore(JFrame frame, int score) {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try (PrintWriter out= new PrintWriter(new BufferedWriter(new FileWriter(file, true)))) {
                ...
                JOptionPane.showMessageDialog(frame, e.toString(), e.getClass().getName(),
