 ...
 * It was an interesting assignment which I thought wasn't too hard. <br>
 * Overall, it was enjoyable, and effective as was A2, effective in getting us <br>
 * accustomed to string and array functions in Java.
 *
 *  */
...
public class A3 {
    ...
    public static double timeSpent= 1.25;
    ...
    public static boolean midsAreEqual(String s) {
        ...
        if (s.length() % 2 == 1 || s.length() == 0) return true;
        else {
            int i= s.length() / 2;
    ...
    public static String putCapsFirst(String s) {
        ...
        StringBuilder notUpper= new StringBuilder("");
        ...
        return upper.toString() + notUpper.toString();
    }
    ...
    public static boolean moreThan1(String s, String t) {
        ...
        int cont= s.indexOf(t);
        if (cont == -1) return false;

        String q= s.substring(cont + 1);
        if (q.indexOf(t) == -1) return false;
        return true;
    }
    ...
    * duplicate("35")          is "33333". */
    public static String duplicate(String s) {
        ...
        s= s.trim();
        return s.substring(0, 1).repeat(s.charAt(1) - '0');
    }
